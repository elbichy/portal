@extends('layouts.app', ['title' => 'Applicants - Shortlisted'])
    ...
    <div class="my-content-wrapper">
        <div class="content-container">
            <div class="sectionWrap">
                {{-- SALES HEADING --}}
                <h6 class="center sectionHeading">APPLICANTS SORTING - (Shortlisted)</h6>
